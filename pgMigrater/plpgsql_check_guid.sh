Compiling plpgsql_check extension with PostgreSQL 10
ref:
...
Set PostgreSQL 10,pg_config in PATH before compiling.
...
6
Switch as “postgres” user, connect to database and create extension
